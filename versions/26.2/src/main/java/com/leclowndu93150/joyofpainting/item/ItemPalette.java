...
public class ItemPalette extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> tooltip, TooltipFlag flag) {
        ...
        if (basic != null) {
            ...
            tooltip.accept(Component.translatable("palette.basic_count", String.valueOf(count)).withStyle(ChatFormatting.GRAY));
        }
        if (custom != null) {
            tooltip.accept(Component.translatable("palette.custom_count", String.valueOf(custom.filledCount())).withStyle(ChatFormatting.GRAY));
        }
    }
}
