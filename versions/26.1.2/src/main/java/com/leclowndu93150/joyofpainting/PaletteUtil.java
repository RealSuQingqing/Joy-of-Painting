...
public class PaletteUtil {
    ...
    public static class CustomColor {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CustomColor c)) return false;
            return totalRed == c.totalRed && totalGreen == c.totalGreen && totalBlue == c.totalBlue
                    && totalMaximum == c.totalMaximum && numberOfColors == c.numberOfColors;
        }
