...
public final class ClientPacketHandler {
    ...
    public static void handleCloseGui(CloseGuiPacket msg) {
        Minecraft.getInstance().setScreen(null);
    }

    public static void handleExport(ExportPaintingPacket msg) {
    ...
    public static void handleImport(ImportPaintingPacket msg) {
